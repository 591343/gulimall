...
import com.xiaochen.gulimall.search.feign.ProductFeignService;
import com.xiaochen.gulimall.search.service.MallSearchService;
import com.xiaochen.gulimall.search.vo.request.BrandVo;
import com.xiaochen.gulimall.search.vo.request.SearchParam;
import com.xiaochen.gulimall.search.vo.response.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    public SearchResult search(SearchParam Param) {
        ...
        try {
            // 2.执行检索请求
            SearchResponse response = restHighLevelClient.search(searchRequest, GulimallElasticSearchConfiguration.COMMON_OPTIONS);
    ...
    private SearchRequest buildSearchRequest(SearchParam Param) {
        ...
        if(StringUtils.isEmpty(Param.getCatalog3Id() != null)){
            assert Param.getCatalog3Id() != null;
        ...
        SearchRequest searchRequest = new SearchRequest(new String[]{EsConstant.PRODUCT_STATS_UP_INDEX}, sourceBuilder);
