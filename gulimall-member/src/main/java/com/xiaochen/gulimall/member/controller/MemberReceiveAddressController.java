...
public class MemberReceiveAddressController {
    ...
    public List<MemberReceiveAddressEntity> memberAddress(@PathVariable("memberid") Long memberId){
        List<MemberReceiveAddressEntity> list=memberReceiveAddressService.listMemberAddress(memberId);
        return list;
    }
    /**
     * 列表
    ...
    public MemberReceiveAddressEntity addr(@PathVariable("id") Long id){
